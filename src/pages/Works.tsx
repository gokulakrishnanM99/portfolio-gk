...
import { Quote, Image, ArrowRight, BookOpen, ExternalLink, Calendar } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 pb-20">
          ...
          >
            ...
            <div className="p-8 flex flex-col flex-grow">
              <div className="flex items-center justify-between mb-4">
                  {blog.readTime && (
                    <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-500">
                        <BookOpen className="w-3 h-3" />
                        <span>{blog.readTime}</span>
                    </div>
                  )}
                  {/* If no date but dynamic, maybe show 'Blog' tag? */}
                  {!blog.date && (
              ...
              {blog.subtitle ? (
                ...
                <p className="text-slate-500 dark:text-slate-500 text-sm mb-6 italic">
      ...
      {blogs.length === 0 && (
         <div className="py-20 text-center flex flex-col items-center justify-center border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl">
           ...
           <p className="text-slate-400 text-sm mt-1">Add images to <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">src/assets/blogs/title-slug.jpg</code></p>
         </div>
      )}
    </div>
  );
    ...
    <div className="max-w-7xl mx-auto px-4 pb-20">
      ...
      {quotes.length > 0 ? (
        ...
        <div className="py-20 text-center flex flex-col items-center justify-center border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl">
           ...
           <p className="text-slate-400 text-sm mt-1">Add .txt or images to <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">src/assets/quotes/</code></p>
         </div>
      )}
    </div>
  );
    ...
    <div className="max-w-7xl mx-auto px-4 pb-20">
      ...
      {designs.length > 0 ? (
        ...
        <div className="py-20 text-center flex flex-col items-center justify-center border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl">
           ...
           <p className="text-slate-500 font-medium">No designs found</p>
           <p className="text-slate-400 text-sm mt-1">Add images to <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">src/assets/designs/Category/Name.jpg</code></p>
         </div>
      )}
    </div>
  );
